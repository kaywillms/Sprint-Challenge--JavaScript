...
console.log(dinoInfo[0].weight);

// What was the diet of a velociraptor?
console.log(dinoInfo[2].diet);

// How long was a stegosaurus?
console.log(dinoInfo[1].length);

// What time period did tyrannosaurus live in?
console.log(dinoInfo[0].period);
...
const contactInfo = [
  "Cynde ctorry0@macromedia.com", "Saundra swhal1@state.gov", "Lambert lparham2@techcrunch.com", "Modestine mdolder3@symantec.com", "Chick camorts4@google.com.au", "Jakob jharken5@spiegel.de", "Robbi rbrister6@redcross.org",
